// Content copied/pasted from the judilibre-index/public/nac.json file
...
const taxon = {
  1: {
    ...
    subs: {
      ...
      11: 'Etat civil',
      12: 'Nom - Prénom',
      13: 'Absence et disparition',
      14: 'Droits attachés à la personne',
      15: 'Incapacité des mineurs',
      16: "Majeurs protégés : ouverture d'un régime de protection et mandat de protection future",
      17: 'Majeurs protégés : fonctionnement des régimes de protection',
      18: 'Majeurs protégés : clôture des régimes de protection et demandes consécutives à la clôture',
      '10A':
      ...
      '11B': "Demande de rectification d'un acte de l'état civil",
      '11C': "Demande sanctionnant le dysfonctionnement de l'état civil",
      '11D': "Demande d'annulation d'un acte d'état civil ou des pièces en tenant lieu",
      '11E': "Demande de modification du sexe dans les actes d'état civil",
      ...
      '11Z': "Autres demandes concernant l'état civil",
      '12A':
        "Demande de changement, de substitution ou de reprise de nom d'un enfant naturel (action introduite devant le TGI avant le 1er juillet 2006)",
      ...
      '13C': "Demande de constatation de présomption d'absence",
      '13D': "Demande de déclaration d'absence",
      '13E': "Demande d'annulation d'un jugement déclaratif d'absence",
      '13Z': "Autres demandes relatives à l'absence et à la disparition",
      ...
      '14F': "Demande relative au don d'organes",
      ...
      '14Q':
        "Demande d'autorisation de prolongation des mesures de rétention prises à l'encontre des étrangers en situation irrégulière",
      '14R':
      ...
      '15B':
        "Demande d'autorisation d'un acte ou de désignation d'un administrateur ad hoc dans le cadre de l'administration légale sous contrôle judiciaire",
      '15C': "Demande d'ouverture d'une tutelle - Incapacité des mineurs -",
      '15D': "Recours exercé à l'encontre d'une décision d'un organe tutélaire - Incapacité des mineurs -",
      '15E': "Demande d'émancipation",
      '15F':
      ...
      '16B': "Demande d'ouverture d'un régime de protection sans autre indication",
      '16C': "Demande d'ouverture d'une tutelle - majeurs protégés -",
      '16D': "Demande d'ouverture d'une curatelle",
      '16E': 'Demande de conversion de tutelle en curatelle',
      '16F': 'Demande de conversion de curatelle en tutelle',
      '16G': "Demande d'ouverture d'une tutelle aux prestations sociales",
      '16H': "Demande d'ouverture d'une mesure d'accompagnement judiciaire",
      '16I': "Demande de conversion de tutelle aux prestations sociales en mesure d'accompagnement judiciaire",
      '16J': 'Demande de placement sous sauvegarde de justice - mesure autonome -',
      '16K':
        "Demande de versement direct des prestations sociales au bailleur -contrat d'accompagnement social personnalisé-",
      '16M': "Contestation de la mise en oeuvre ou de l'exécution d'un mandat de protection future",
      '16N': "Demande d'autorisation d'accomplir un acte dans le cadre d'un mandat de protection future",
      '16O': "Demande aux fins de désignation d'une personne habilitée",
      '16P': "Demande de conversion d'une tutelle en habilitation familiale",
      '16Q': "Demande de conversion d'une curatelle en habilitation familiale",
      '16R': "Demande de conversion d'une habilitation familiale en tutelle",
      '16S': "Demande de conversion d'une habilitation familiale en curatelle",
      '16X': "Majeurs protégés : ouverture d'un régime de protection - nature d'affaire indéterminée",
      '17A': "Recours contre une décision relative à la gestion de la personne et/ou des biens d'un majeur protégé",
      '17B':
        "Recours contre une décision relative à la  désignation ou à la  révocation d'un mandataire du majeur placé sous sauvegarde de justice",
      '17C':
        "Recours contre une décision relative à une demande d'autorisation supplétive d'un acte formée par un majeur en curatelle",
      '17D': "Demande tendant à modifier l'étendue de la curatelle",
      '17E': "Demande tendant à modifier l'étendue de la tutelle",
      '17F': "Recours exercé à l'encontre d'une décision d'un organe tutélaire - majeurs protégés -",
      '17G': "Demande de modification de l'étendue de la tutelle aux prestations sociales",
      '17H': 'Demande de renouvellement de la tutelle aux prestations sociales',
      '17I': "Demande de modification de l'étendue de la mesure d'accompagnement judiciaire",
      '17J': "Demande de renouvellement de la mesure d'accompagnement judiciaire",
      '17K': 'Demande de renouvellement de la mesure de tutelle',
      '17L': 'Demande de renouvellement de la mesure de curatelle',
      '17M': 'Demande de renouvellement de la mesure de sauvegarde de justice',
      ...
      '17X': "Majeurs protégés : fonctionnement des régimes de protection - nature d'affaire indéterminée",
      '18A': "Demande de mainlevée d'une tutelle",
      '18B': "Demande de mainlevée d'une curatelle",
      '18C': "Appel relatif à la mainlevée d'une mesure en faveur d'un jeune majeur",
      '18D': "Demande de mainlevée d'une tutelle aux prestations sociales",
      '18E': "Demande de mainlevée d'une mesure d'accompagnement judiciaire",
      '18F': 'Demande de mainlevée de la mesure de sauvegarde de justice',
      '18G':
        "Demande de mainlevée du versement direct des prestations sociales au bailleur -contrat d'accompagnement social personnalisé-",
  ...
  2: {
    ...
    subs: {
      ...
      '20G': 'Demande de modification des mesures provisoires - divorce -',
      ...
      '20X': 'Demande de modification des mesures accessoires divorce sans autre indication',
      ...
      '21F': 'Demande de modification des mesures provisoires - séparation de corps -',
      '21G':
      ...
      '21I': 'Art. 751 du CPC - Demande en séparation de corps autre que par consentement mutuel',
      '21J': 'Demande en séparation de corps par consentement mutuel - passerelle -',
      '21K': 'Art. 1107 du CPC - Demande en séparation de corps autre que par consentement mutuel',
      '21X': 'Demande de modification des mesures accessoires',
      '22A':
        "Demande de modification de l'exercice de l'autorité parentale ou de la résidence habituelle des enfants mineurs - après divorce ou séparation de corps -",
      '22B': "Demande de révision de la prestation compensatoire ou de substitution d'un capital à la rente",
      '22C':
        "Demande de modification de la contribution à l'entretien des enfants - après divorce ou séparation de corps -",
      '22D': 'Demande de fixation ou de modification de la pension alimentaire versée au conjoint',
      '22E': 'Demande de modification du droit de visite - après divorce ou séparation de corps -',
      '22F': "Demande relative au bail concédé à l'un des époux",
      ...
      '23C': "Demande en nullité d'un acte passé par un époux sans le consentement de l'autre",
      '23D': "Demande d'autorisation à passer seul un acte",
      '23E':
        "Demande relative à l'habilitation à représenter l'autre conjoint, ou à lui être substitué dans la gestion des biens propres ou communs",
      '23F':
      ...
      '23G': "Demande d'homologation du changement de régime matrimonial",
      ...
      '23Z': 'Autres demandes relatives au mariage et au régime matrimonial',
      '24A': 'Demande relative à la pension alimentaire des enfants nés hors mariage',
      '24B':
        "Demande tendant à faire décharger le débiteur de tout ou partie de sa dette pour cause d'ingratitude du créancier",
      '24C': "Demande d'entretien formée par l'enfant majeur",
      '24D': "Recours entre codébiteurs d'aliments",
      '24E': "Recours des tiers payeurs contre les débiteurs d'aliments",
      '24F': 'Contribution aux charges du mariage',
      ...
      '24I': 'Demande relative à la fixation de la pension alimentaire des enfants - parents non mariés -',
      '24J': 'Demande relative à la révision de la pension alimentaire des enfants - parents non mariés -',
      '24K':
        "Demande relative à la fixation de l'obligation alimentaire formée par l'enfant majeur à l'égard de ses parents ou autres ascendants",
      '24L':
      ...
      '25B':
        'Action en contestation de paternité formée par la mère remariée (action introduite devant le TGI avant le 1er juillet 2006)',
      '25C':
        'Autres actions tendant à contester la présomption de paternité légitime (action introduite devant le TGI avant le 1er juillet 2006)',
      '25D':
        'Action en rétablissement de la présomption de paternité légitime (action introduite devant le TGI avant le 1er juillet 2006)',
      '25E':
        "Action en contestation d'état, action en réclamation d'état (action introduite devant le TGI avant le 1er juillet 2006)",
      '25F': "Action en revendication d'enfant légitime (action introduite devant le TGI avant le 1er juillet 2006)",
      '25G':
        'Demande de légitimation postérieurement au mariage (action introduite devant le TGI avant le 1er juillet 2006)',
      '25H':
        "Demande relative au consentement à une procréation médicalement assistée ou à la délivrance d'un acte de notoriété constatant la possession d'état d'enfant légitime (action introduite devant le TGI avant le 1er juillet 2006)",
      '25I':
        'Demande de légitimation par autorité de justice (action introduite devant le TGI avant le 1er juillet 2006)',
      '26A':
      ...
      '26B': 'Action en recherche de paternité naturelle (action introduite devant le TGI avant le 1er juillet 2006)',
      '26C': 'Action en recherche de maternité naturelle (action introduite devant le TGI avant le 1er juillet 2006)',
      '26D': "Demande tendant à la restitution de l'enfant après rétractation du consentement à l'adoption",
      ...
      '26I':
        "Demande relative au consentement à une procréation médicalement assistée ou à la délivrance d'un acte de notoriété constatant la possession d'état - filiation naturelle - (action introduite devant le TGI avant le 1er juillet 2006)",
      '26J': "Demande d'adoption simple de l'enfant du conjoint, partenaire ou concubin",
      '26K': "Demande d'adoption plénière de l'enfant du conjoint, partenaire ou concubin",
      ...
      '27A': 'Demande relative au droit de visite des grands-parents ou autres personnes, parents ou non',
      '27B':
        "Demande tendant à faire trancher un conflit relatif à l'exercice de l'autorité parentale - parents mariés -",
      '27C': "Demande de délégation ou de transfert de délégation de l'autorité parentale",
      '27D': "Demande de retrait total ou partiel de l'autorité parentale",
      '27E': "Demande de restitution de l'autorité parentale",
      '27F':
      ...
      '27G': "Recours en matière de mesure judiciaire d'aide à la gestion du budget familial",
      '27H': "Recours contre une mesure relative à l'assistance éducative",
      '27I':
        "Demande relative à l'exercice de l'autorité parentale à l'égard de l'enfant qui a fait l'objet d'une adoption simple par le conjoint",
  ...
  3: {
    ...
    subs: {
      ...
      33: "Nantissement du fonds de commerce ou du fonds artisanal, de l'outillage, et du matériel d'équipement ou gage des stocks",
      ...
      '30D': 'Action relative à la déspécialisation',
      ...
      '33A': 'Demande de vente forcée du fonds nanti et/ou en surenchère du 10ø',
      ...
      '33Z':
        "Autres demandes en matière de nantissement du fonds de commerce ou du fonds artisanal , du matériel ou de l'outillage ou du gage des stocks",
      ...
      '35B': 'Action en opposition des créanciers contre un projet de fusion, scission, ou de réduction de capital',
      '35C':
      ...
      '35X': 'Demande relative au fonctionnement des groupements',
      ...
      '39B':
        "Demande en contrefaçon et/ou en nullité de brevet, d'obtention végétale ou de topographie de semi conducteur (Ce poste ne doit plus être utilisé à compter du 1er janvier 2009)",
      '39C':
        'Demande en contrefaçon et/ou en nullité de marque (Ce poste ne doit plus être utilisé à compter du 1er janvier 2009)',
      '39D':
        'Demande en contrefaçon et/ou en nullité de dessins et modèles (Ce poste ne doit plus être utilisé à compter du 1er janvier 2009)',
      '39E':
        'Demande en délivrance de licence et/ou en fixation de redevances (Ce poste ne doit plus être utilisé à compter du 1er janvier 2009)',
      '39F':
        "Demande en exécution, nullité, résolution d'un contrat de licence et cession de brevet, d'obtention végétale, de topographie de semi conducteur ou de marque (Ce poste ne doit plus être utilisé à compter du 1er janvier 2009)",
  ...
  4: {
    label: 'Entreprises en difficulté et surendettement des particuliers, faillite civile, rétablissement personnel',
    subs: {
      ...
      '40C':
        "Demande d'ouverture d'une procédure de règlement amiable ou de désignation d'un conciliateur (procédures ouvertes avant le 1er janvier 2006)",
      '40D':
      ...
      '40E':
        "Demande de redressement judiciaire à l'encontre du locataire-gérant en cas d'inexécution de ses obligations (procédures ouvertes avant le 1er janvier 2006)",
      '40F':
        "Demande d'ouverture d'une procédure de liquidation judiciaire  en cas de résolution du plan de continuation (procédures ouvertes avant le 1er janvier 2006)",
      '40G':
      ...
      '40H':
        "Demande d'extension aux dirigeants du redressement ou de la liquidation judicaire (procédures ouvertes avant le 1er janvier 2006)",
      '40I':
        'Demande de reprise de la procédure de redressement judiciaire (procédures ouvertes avant le 1er janvier 2006)',
      '41A':
      ...
      '42A':
        "Appel sur des décisions relatives à l'autorisation ou à la résiliation d'un contrat de location gérance ou à la nullité des actes du débiteur non autorisés par le juge commissaire ou d'homologation de compromis, de transaction (proc.ouvertes av.01/01/06)",
      '42B':
        'Appel sur des décisions relatives au remplacement du ou des dirigeants, ou de privation du droit de vote, ou de cession forcée des actions (procédures ouvertes avant le 1er janvier 2006)',
      '42X': 'Demandes relatives aux autorisations et actions diverses sans autre indication',
      '43A':
        'Demande en modification de la date de la cessation des paiements (procédures ouvertes avant le 1er janvier 2006)',
      '43B': 'Demande en nullité des actes de la période suspecte (procédures ouvertes avant le 1er janvier 2006)',
      '43C':
      ...
      '44A':
        "Appel sur une décision relative à l'admission du plan de continuation (procédures ouvertes avant le 1er janvier 2006)",
      '44B':
        'Appel sur une décision  relative à la modification substantielle du plan de continuation (procédures ouvertes avant le 1er janvier 2006)',
      '44C':
        "Demande en nullité d'un acte passé en violation d'une inaliénabilité temporaire (procédures ouvertes avant le 1er janvier 2006)",
      '44X': "Demande relative au plan de continuation de l'entreprise sans autre indication",
      '45A':
        "Appel sur une décision relative à l'admission du plan de cession sans location gérance (procédures ouvertes avant le 1er janvier 2006)",
      '45B':
        "Appel sur une décision relative à l'admission du plan de cession avec location gérance (procédures ouvertes avant le 1er janvier 2006)",
      '45C':
      ...
      '45D':
        "Appel sur une décision relative à l'autorisation par le cessionnaire d'aliéner des biens, les louer, les grever de sûretés (procédures ouvertes avant le 1er janvier 2006)",
      '45E': 'Demande en nullité des actes interdits au cessionnaire (procédures ouvertes avant le 1er janvier 2006)',
      '45F':
        "Appel sur une décision de nomination d'un administrateur ad hoc (procédures ouvertes avant le 1er janvier 2006)",
      '45G': 'Demande de clôture du plan de cession (procédures ouvertes avant le 1er janvier 2006)',
      '45H': 'Demande de résolution du plan de cession (procédures ouvertes avant le 1er janvier 2006)',
      '45X': "Demandes relatives à l'exécution du plan de cession sans autre indication",
      '46A': 'Demande de clôture pour extinction du passif (procédures ouvertes avant le 1er janvier 2006)',
      '46B': "Demande de clôture pour insuffisance d'actif (procédures ouvertes avant le 1er janvier 2006)",
      '46X': 'Demande relative à la liquidation judiciaire-à la clôture des opérations sans autre indication',
      '47A':
      ...
      '47B':
        "Demande de prononcé de la faillite personnelle ou d'autres sanctions (procédures ouvertes avant le 1er janvier 2006)",
      '47C':
        "Action en responsabilité exercée contre l'administrateur, le représentant des créanciers, le liquidateur, le commissaire à l'exécution du plan (procédures ouvertes avant le 1er janvier 2006)",
      '47D':
      ...
      '47F': 'Action en responsabilité exercée contre les fournisseurs (procédures ouvertes avant le 1er janvier 2006)',
      '47G':
        'Demande relative au règlement judiciaire, à la liquidation des biens, aux sanctions et à la suspension provisoire des poursuites (procédures ouvertes avant le 1er janvier 2006)',
      '47X': 'Autres demandes en matière de redressement ou liquidation judiciaires sans autre indication',
      '48A':
      ...
      '48C': 'Contestation des mesures imposées ou recommandées par la commission de surendettement des particuliers',
      ...
      '48I':
        'Demande aux fins de conférer force exécutoire aux recommandations de rétablissement personnel sans liquidation judiciaire',
      '48J': 'Contestation des recommandations aux fins de rétablissement personnel sans liquidation judiciaire',
  ...
  5: {
    ...
    subs: {
      ...
      '57X': "Autres demandes relatives à un contrat d'intermédiaire",
      '58A':
      ...
      '5AD': "Baux d'habitation - Demande du  locataire ou de l'ancien locataire tendant au maintien dans les lieux",
      '5AE':
      ...
      '5AG':
        "Baux d'habitation - Demande du locataire tendant à la diminution du loyer ou des charges, et/ou à la résiliation du bail, et/ou à des dommages-intérêts,  en raison de troubles de jouissance",
      '5AH':
      ...
      '5AI': "Baux d'habitation - Demande tendant à la fixation judiciaire du montant du loyer",
      '5AJ':
        "Baux d'habitation - Demande du bailleur tendant à faire constater la résiliation du bail pour abandon du domicile par le locataire",
      '5AK':
        "Baux d'habitation - Demande du locataire tendant à la diminution du loyer en raison de l'absence de certaines mentions ou de la présence de mentions erronées dans le contrat de location et/ou demande tendant à la mise en conformité du bail",
      '5AL':
        "Baux d'habitation - Demande du locataire tendant à la diminution du loyer lorsque son montant est supérieur au loyer de référence majoré",
      '5AM':
      ...
      '5BB':
        "Baux professionnels - Demande tendant à l'exécution des autres obligations du locataire et/ou tendant à faire prononcer  la résiliation pour inexécution de ces obligations et ordonner l'expulsion",
      '5BC':
        "Baux professionnels - Demande du bailleur tendant à faire constater la validité du congé et à ordonner l'expulsion",
      '5BD':
        'Baux professionnels - Demande en dommages-intérêts formée par le bailleur en fin de bail en raison des dégradations ou des pertes imputables au locataire',
      '5BE': "Baux professionnels - Demande du  locataire ou de l'ancien locataire tendant au maintien dans les lieux",
      '5BF':
        'Baux professionnels - Demande du locataire tendant à la diminution du loyer ou des charges et/ou à la résiliation du bail et/ou à des dommages-intérêts en raison de troubles de jouissance',
      '5BG':
      ...
      '5BH':
        "Baux professionnels - Demande du locataire tendant  à être autorisé d'exécuter des travaux ou à faire exécuter des travaux à la charge du bailleur",
      '5BI': 'Baux professionnels - Demande tendant à la fixation judiciaire du montant du loyer',
      '5BZ': 'Baux professionnels - Autres demandes relatives à un bail professionnel',
    },
  },
  6: {
    label: 'Responsabilité et quasi-contrats',
    subs: {
      ...
      '62X': 'Demande relative à la responsabilité du fait des choses immobilières sans autre indication',
  ...
  7: {
    ...
    subs: {
      ...
      '70G': "Demande d'ordonnance d'expropriation",
      '70H': "Demande de fixation de l'indemnité d'expropriation",
      '70I': "Demande de rétrocession d'un immeuble exproprié",
      '70J': "Demande relative à l'inscription ou à la radiation d'un droit ou d'une charge au Livre foncier",
      ...
      '71J':
        "Demande de désignation d'un mandataire ad hoc d'une copropriété en pré-difficulté dans le cadre d'une procédure d'alerte",
      ...
      '73X': "Demandes relatives à l'usufruit sans autre indication",
      ...
      '76X': 'Demande relative à un gage ou à un nantissement sans autre indication',
      ...
      '78J': "Demande d'autorisation d'une visite et/ou d'une mesure conservatoire",
      ...
      '78N':
        "Demande d'autorisation de mesures conservatoires et de mesures d'exécution forcée sur les biens des états étrangers.",
      ...
      '78S':
        "Demande d'autorisation de visites et de saisies administratives dans le cadre de la prévention de la commission d'actes de terrorisme",
      '78T': "Demande d'autorisation d'une mesure conservatoire",
      '78U':
        "Demande d'autorisation d'une visite et/ou d'une saisie et/ou d'une mesure conservatoire formée devant le JLD",
      '78X': 'Demande relative aux saisies et mesure conservatoire sans autre indication',
      '79A':
  ...
  8: {
    label: 'Relations du travail et protection sociale',
    subs: {
      ...
      '80M': 'Demande de résiliation ou de résolution judiciaire du contat de travail formée par un salarié',
      ...
      '81K':
        'Contestation de la décision administrative relative au scrutin sur sigle organisé dans les très petites entreprises',
      ...
      '84J': "Contestation de la rupture du contrat de travail présenté après l'ouverture d'une procédure collective",
      '84K':
      ...
      '87C':
        "Demande formée par un employeur ou un salarié contre un organisme de formation, un organisme paritaire collecteur agréé ou un fonds d'assurance-formation",
      ...
      '87X': "Demande relative à la formation et l'insertion professionnelles sans autre indication",
      '88A':
      ...
      '88K': 'Demande en répétition de prestations ou allocations indument versées',
      ...
      '88X': "Aide sociale - Contestation d'une décision relative aux allocations et/ou aux droits des personnes âgées",
  ...
  9: {
    ...
    subs: {
      ...
      '94A':
        "Contestation par l'électeur de la décision de la commission de contrôle concernant son inscription ou sa radiation des listes électorales",
      '94B':
      ...
      '97A': "Recours contre les décisions des commissions d'indemnisation de victimes",
      '97B': "Recours contre les décisions des juridictions disciplinaires des ordres d'avocats",
      ...
      '97F': 'Demandes et recours relatifs à la discipline des experts',
      '97G': "Demande relative à l'immatriculation au registre du commerce et des sociétés",
      '97H': "Recours contre les décisions de l'autorité de la Concurrence",
      '97I':
        'Recours contre une décision administrative relative au maintien en rétention des étrangers (ce poste ne doit plus être utilisé à compter du 1er janvier 2009)',
      '97J': 'Contestation concernant le montant et le recouvrement des honoraires des avocats',
