...
const { parseQuerystring } = require('./jurilang/parser');

function buildQuery(query) {
  const jlQuery = parseQuerystring(query)
  const esQuery = convertJurilangToEs(jlQuery)
  return { ...esQuery, highlight: { fields: { text: {} } } }
}
